...
│                          │                                      │
│                          ▼                                      │
│  2. LLM analiza y decide usar herramienta                       │
│     { tool: "get_weather", input: { city: "Madrid" } }          │
│                          │                                      │
│                          ▼                                      │
│  3. Tu código ejecuta la herramienta                            │
│     const result = await weatherAPI.get("Madrid");              │
│                          │                                      │
│                          ▼                                      │
│  4. Envías resultado de vuelta al LLM                           │
│     { tool_result: { temperature: 22, condition: "sunny" } }    │
│                          │                                      │
│                          ▼                                      │
│  5. LLM genera respuesta final                                  │
│     "El clima en Madrid es soleado con 22°C"                    │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
│                                                            │
│    ┌──────────────┐                                        │
│    │   THOUGHT    │  "Necesito buscar información sobre    │
│    │  (Razonar)   │   TypeScript para responder..."        │
│    └──────┬───────┘                                        │
│           │                                                │
│           ▼                                                │
│    ┌──────────────┐                                        │
│    │    ACTION    │  search_web({ query: "TypeScript" })   │
│    │   (Actuar)   │                                        │
│    └──────┬───────┘                                        │
│           │                                                │
│           ▼                                                │
│    ┌──────────────┐                                        │
│    │ OBSERVATION  │  [{ title: "TS Handbook", ... }]       │
│    │  (Observar)  │                                        │
│    └──────┬───────┘                                        │
│           │                                                │
│           ▼                                                │
│    ┌──────────────┐                                        │
│    │   ¿Listo?    │──── Sí ───▶ Respuesta final            │
│    └──────┬───────┘                                        │
│           │                                                │
│           No                                               │
│           │                                                │
...
**Anterior**: [Módulo 2: TypeScript Esencial para Agentes](./02-typescript.md)

**Siguiente**: [Módulo 4: Agentes Avanzados con Claude](./04-agentes-avanzados.md)
