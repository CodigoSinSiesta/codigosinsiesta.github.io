...
|----------------|---------------|
| Nada de IA, pero sé JavaScript | [Módulo 1: Fundamentos](./01-fundamentos) |
| Conceptos de IA, pero no TypeScript | [Módulo 2: TypeScript Esencial](./02-typescript) |
| TypeScript + conceptos de IA básicos | [Módulo 3: Conceptos de Agentes](./03-conceptos) |
| Ya construí agentes simples | [Módulo 4: Agentes Avanzados](./04-agentes-avanzados) |
| Quiero crear herramientas para Claude | [Módulo 5: MCP Servers](./05-mcp-servers) |
...
|--------|----------|-----------|-----------|
| **[1. Fundamentos](./01-fundamentos)** | 1.5 horas | JavaScript básico | Qué es un agente de IA, LLMs, APIs, prompting básico |
| **[2. TypeScript Esencial](./02-typescript)** | 2 horas | Módulo 1, ES6+ | Tipos para APIs, zod validation, error handling |
| **[3. Conceptos de Agentes](./03-conceptos)** | 2.5 horas | Módulo 2 | Tool calling, ReAct pattern, state management |
| **[4. Agentes Avanzados](./04-agentes-avanzados)** | 3 horas | Módulo 3 | Prompt engineering, context windows, streaming |
| **[5. MCP Servers](./05-mcp-servers)** | 2.5 horas | Módulo 4 | Protocolo MCP, FastMCP, tool schemas |
| **[6. Producción](./06-produccion)** | 3 horas | Módulo 5 | Testing, security, deployment, monitoring |
...
**Siguiente**: [Módulo 1: Fundamentos de IA para Desarrolladores](./01-fundamentos)
